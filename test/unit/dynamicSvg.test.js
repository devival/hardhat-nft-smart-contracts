...
!developmentChains.includes(network.name)
    ...
    : describe("Dynamic SVG NFT Unit Tests", function () {
          ...
          beforeEach(async () => {
              ...
              deployer = accounts[0]
              await deployments.fixture(["mocks", "dynamicsvg"]) // deploys module with the tag "DynamicSvgNft"
              dynamicSvgNft = await ethers.getContract("DynamicSvgNft") // Returns a new connection to the DynamicSvgNft contract
